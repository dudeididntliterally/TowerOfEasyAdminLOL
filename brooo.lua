...
function Teleport(Player, Position)
	...
	until STOP_2 > 10
    wait()
	if game.Players.LocalPlayer.Character == nil or game.Players.LocalPlayer.Character:FindFirstChild("Humanoid") == nil then
	    repeat wait() until game.Players and game.Players.LocalPlayer and game.Players.LocalPlayer.Character and game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")
	end
	local char = game.Players.LocalPlayer.Character
